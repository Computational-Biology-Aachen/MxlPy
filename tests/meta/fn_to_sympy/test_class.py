...
def test_class_l1() -> None:
    assert fn_to_sympy_expr(fn_class_l1_attr, origin="test") == 3.0


def test_class_l2_i1() -> None:
    assert fn_to_sympy_expr(fn_class_l2_i1, origin="test") == 3.0


def test_class_l3_i2() -> None:
    assert fn_to_sympy_expr(fn_class_l3_i2, origin="test") == 3.0
...
def test_class_l2_attr() -> None:
    assert fn_to_sympy_expr(fn_class_l2_attr, origin="test") == 2.0


def test_class_l3_i1() -> None:
    assert fn_to_sympy_expr(fn_class_l3_i1, origin="test") == 2.0
...
def test_class_l3_attr() -> None:
    assert fn_to_sympy_expr(fn_class_l3_attr, origin="test") == 1.0
