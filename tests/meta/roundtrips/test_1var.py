...
def model_1var() -> KineticModelBuilder:
    return KineticModelBuilder().add_variable("v1", initial_value=1.0)


def test_generate_model_code_jax() -> None:
    assert meta.generate_model_code_jax(model_1var()).full().split("\n") == [
        "import jax",
