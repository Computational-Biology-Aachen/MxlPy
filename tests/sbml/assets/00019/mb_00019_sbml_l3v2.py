...
def reaction3(k3: float, S3_conc: float) -> float:
    return S3_conc * k3
...
def reaction3_stoich_S1(compartment: float) -> float:
    return 1.0 * compartment
    ...
    return (
        ...
        .add_reaction(
            ...
            stoichiometry={
                ...
                "S1": Derived(fn=reaction3_stoich_S1, args=["compartment"]),
