...
def create_model() -> KineticModelBuilder:
    ...
    m.add_variable("pp9_mrna", initial_value=0.0)
    m.add_variable("p9", initial_value=0.0)
    m.add_variable("pp8_mrna", initial_value=0.0)
    m.add_variable("p8", initial_value=0.0)
    m.add_variable("pp7_mrna", initial_value=0.0)
    m.add_variable("p7", initial_value=0.0)
    m.add_variable("pp6_mrna", initial_value=0.0)
    m.add_variable("p6", initial_value=0.0)
    m.add_variable("pp5_mrna", initial_value=0.0)
    m.add_variable("p5", initial_value=0.0)
    m.add_variable("pp4_mrna", initial_value=0.0)
    m.add_variable("p4", initial_value=0.0)
    m.add_variable("pp3_mrna", initial_value=0.0)
    m.add_variable("p3", initial_value=0.0)
    m.add_variable("pp2_mrna", initial_value=0.0)
    m.add_variable("p2", initial_value=0.0)
    m.add_variable("pp1_mrna", initial_value=0.0)
    m.add_variable("p1", initial_value=5.0)
    m.add_parameter("pp8_mrna_degradation_rate", value=1.0)
    m.add_parameter("pp9_mrna_degradation_rate", value=1.0)
    m.add_parameter("p1_degradation_rate", value=0.5)
    m.add_parameter("p2_degradation_rate", value=0.5)
    m.add_parameter("p3_degradation_rate", value=0.5)
    m.add_parameter("p4_degradation_rate", value=0.5)
    m.add_parameter("p5_degradation_rate", value=0.5)
    m.add_parameter("p6_degradation_rate", value=0.5)
    m.add_parameter("p7_degradation_rate", value=0.5)
    m.add_parameter("p8_degradation_rate", value=0.5)
    m.add_parameter("p9_degradation_rate", value=0.5)
    m.add_parameter("v1_Kd", value=11.147)
    m.add_parameter("v1_h", value=1.0)
    m.add_parameter("v2_Kd", value=1.0)
    m.add_parameter("v2_h", value=4.0)
    m.add_parameter("v3_Kd", value=20.0)
    m.add_parameter("v3_h", value=1.0)
    m.add_parameter("v4_Kd", value=0.2)
    m.add_parameter("v4_h", value=4.0)
    m.add_parameter("v5_Kd", value=0.2)
    m.add_parameter("v5_h", value=4.0)
    m.add_parameter("v6_Kd", value=0.04)
    m.add_parameter("v6_h", value=4.0)
    m.add_parameter("v7_Kd", value=0.02)
    m.add_parameter("v7_h", value=4.0)
    m.add_parameter("v8_Kd", value=0.04)
    m.add_parameter("v8_h", value=4.0)
    m.add_parameter("v9_Kd", value=0.2)
    m.add_parameter("v9_h", value=4.0)
    m.add_parameter("pp1_mrna_degradation_rate", value=1.0)
    m.add_parameter("pp2_mrna_degradation_rate", value=1.0)
    m.add_parameter("pro1_strength", value=2.0)
    m.add_parameter("pro2_strength", value=4.5077)
    m.add_parameter("pro3_strength", value=5.0)
    m.add_parameter("pro4_strength", value=5.0)
    m.add_parameter("pro5_strength", value=5.0)
    m.add_parameter("pro6_strength", value=1.31)
    m.add_parameter("pro7_strength", value=1.31)
    m.add_parameter("pro8_strength", value=5.0)
    m.add_parameter("pro9_strength", value=5.0)
    m.add_parameter("pp3_mrna_degradation_rate", value=1.0)
    m.add_parameter("v10_Kd", value=0.02)
    m.add_parameter("v10_h", value=4.0)
    m.add_parameter("v11_Kd", value=0.1)
    m.add_parameter("v11_h", value=2.0)
    m.add_parameter("v12_Kd", value=0.1)
    m.add_parameter("v12_h", value=2.0)
    m.add_parameter("v13_Kd", value=0.01)
    m.add_parameter("v13_h", value=2.0)
    m.add_parameter("pp4_mrna_degradation_rate", value=1.0)
    m.add_parameter("v14_Kd", value=1.0)
    m.add_parameter("v14_h", value=4.0)
    m.add_parameter("v15_Kd", value=20.0)
    m.add_parameter("v15_h", value=1.0)
    m.add_parameter("pp5_mrna_degradation_rate", value=1.0)
    m.add_parameter("rbs1_strength", value=0.3668)
    m.add_parameter("rbs2_strength", value=1.4102)
    m.add_parameter("rbs3_strength", value=0.8)
    m.add_parameter("rbs4_strength", value=2.21)
    m.add_parameter("rbs5_strength", value=0.5)
    m.add_parameter("rbs6_strength", value=2.0)
    m.add_parameter("rbs7_strength", value=5.0)
    m.add_parameter("rbs8_strength", value=3.6377)
    m.add_parameter("rbs9_strength", value=8.0)
    m.add_parameter("pp6_mrna_degradation_rate", value=1.0)
    m.add_parameter("pp7_mrna_degradation_rate", value=1.0)
    m.add_parameter("DefaultCompartment", value=1.0)
    m.add_derived(
        "as8",
        fn=as8,
        args=["v9_Kd", "v9_h", "p5"],
    ...
    m.add_reaction(
        ...
        args=["cod9"],
        stoichiometry={
            "pp9_mrna": Derived(fn=pp9_v1_stoich_pp9_mrna, args=["DefaultCompartment"])
        },
    )
    m.add_reaction(
        "pp9_v2",
        ...
        stoichiometry={
            "pp9_mrna": Derived(fn=pp9_v2_stoich_pp9_mrna, args=["DefaultCompartment"])
        },
    )
    m.add_reaction(
        "pp9_v3",
        ...
        stoichiometry={"p9": Derived(fn=pp9_v3_stoich_p9, args=["DefaultCompartment"])},
    )
    m.add_reaction(
        "pp9_v4",
        fn=pp9_v4,
        args=["p9_degradation_rate", "p9_conc"],
        stoichiometry={"p9": Derived(fn=pp9_v4_stoich_p9, args=["DefaultCompartment"])},
    )
    m.add_reaction(
        "pp8_v1",
        fn=pp8_v1,
        args=["cod8"],
        stoichiometry={
            "pp8_mrna": Derived(fn=pp8_v1_stoich_pp8_mrna, args=["DefaultCompartment"])
        },
    )
    m.add_reaction(
        "pp8_v2",
        ...
        stoichiometry={
            "pp8_mrna": Derived(fn=pp8_v2_stoich_pp8_mrna, args=["DefaultCompartment"])
        },
    )
    m.add_reaction(
        "pp8_v3",
        ...
        stoichiometry={"p8": Derived(fn=pp8_v3_stoich_p8, args=["DefaultCompartment"])},
    )
    m.add_reaction(
        "pp8_v4",
        fn=pp8_v4,
        args=["p8_degradation_rate", "p8_conc"],
        stoichiometry={"p8": Derived(fn=pp8_v4_stoich_p8, args=["DefaultCompartment"])},
    )
    m.add_reaction(
        "pp7_v1",
        fn=pp7_v1,
        args=["cod7"],
        stoichiometry={
            "pp7_mrna": Derived(fn=pp7_v1_stoich_pp7_mrna, args=["DefaultCompartment"])
        },
    )
    m.add_reaction(
        "pp7_v2",
        ...
        stoichiometry={
            "pp7_mrna": Derived(fn=pp7_v2_stoich_pp7_mrna, args=["DefaultCompartment"])
        },
    )
    m.add_reaction(
        "pp7_v3",
        ...
        stoichiometry={"p7": Derived(fn=pp7_v3_stoich_p7, args=["DefaultCompartment"])},
    )
    m.add_reaction(
        "pp7_v4",
        fn=pp7_v4,
        args=["p7_conc", "p7_degradation_rate"],
        stoichiometry={"p7": Derived(fn=pp7_v4_stoich_p7, args=["DefaultCompartment"])},
    )
    m.add_reaction(
        "pp6_v1",
        fn=pp6_v1,
        args=["cod6"],
        stoichiometry={
            "pp6_mrna": Derived(fn=pp6_v1_stoich_pp6_mrna, args=["DefaultCompartment"])
        },
    )
    m.add_reaction(
        "pp6_v2",
        ...
        stoichiometry={
            "pp6_mrna": Derived(fn=pp6_v2_stoich_pp6_mrna, args=["DefaultCompartment"])
        },
    )
    m.add_reaction(
        "pp6_v3",
        ...
        stoichiometry={"p6": Derived(fn=pp6_v3_stoich_p6, args=["DefaultCompartment"])},
    )
    m.add_reaction(
        "pp6_v4",
        fn=pp6_v4,
        args=["p6_conc", "p6_degradation_rate"],
        stoichiometry={"p6": Derived(fn=pp6_v4_stoich_p6, args=["DefaultCompartment"])},
    )
    m.add_reaction(
        "pp5_v1",
        fn=pp5_v1,
        args=["cod5"],
        stoichiometry={
            "pp5_mrna": Derived(fn=pp5_v1_stoich_pp5_mrna, args=["DefaultCompartment"])
        },
    )
    m.add_reaction(
        "pp5_v2",
        ...
        stoichiometry={
            "pp5_mrna": Derived(fn=pp5_v2_stoich_pp5_mrna, args=["DefaultCompartment"])
        },
    )
    m.add_reaction(
        "pp5_v3",
        ...
        stoichiometry={"p5": Derived(fn=pp5_v3_stoich_p5, args=["DefaultCompartment"])},
    )
    m.add_reaction(
        "pp5_v4",
        fn=pp5_v4,
        args=["p5_conc", "p5_degradation_rate"],
        stoichiometry={"p5": Derived(fn=pp5_v4_stoich_p5, args=["DefaultCompartment"])},
    )
    m.add_reaction(
        "pp4_v1",
        fn=pp4_v1,
        args=["cod4"],
        stoichiometry={
            "pp4_mrna": Derived(fn=pp4_v1_stoich_pp4_mrna, args=["DefaultCompartment"])
        },
    )
    m.add_reaction(
        "pp4_v2",
        ...
        stoichiometry={
            "pp4_mrna": Derived(fn=pp4_v2_stoich_pp4_mrna, args=["DefaultCompartment"])
        },
    )
    m.add_reaction(
        "pp4_v3",
        ...
        stoichiometry={"p4": Derived(fn=pp4_v3_stoich_p4, args=["DefaultCompartment"])},
    )
    m.add_reaction(
        "pp4_v4",
        fn=pp4_v4,
        args=["p4_degradation_rate", "p4_conc"],
        stoichiometry={"p4": Derived(fn=pp4_v4_stoich_p4, args=["DefaultCompartment"])},
    )
    m.add_reaction(
        "pp3_v1",
        fn=pp3_v1,
        args=["cod3"],
        stoichiometry={
            "pp3_mrna": Derived(fn=pp3_v1_stoich_pp3_mrna, args=["DefaultCompartment"])
        },
    )
    m.add_reaction(
        "pp3_v2",
        ...
        stoichiometry={
            "pp3_mrna": Derived(fn=pp3_v2_stoich_pp3_mrna, args=["DefaultCompartment"])
        },
    )
    m.add_reaction(
        "pp3_v3",
        ...
        stoichiometry={"p3": Derived(fn=pp3_v3_stoich_p3, args=["DefaultCompartment"])},
    )
    m.add_reaction(
        "pp3_v4",
        fn=pp3_v4,
        args=["p3_degradation_rate", "p3_conc"],
        stoichiometry={"p3": Derived(fn=pp3_v4_stoich_p3, args=["DefaultCompartment"])},
    )
    m.add_reaction(
        "pp2_v1",
        fn=pp2_v1,
        args=["cod2"],
        stoichiometry={
            "pp2_mrna": Derived(fn=pp2_v1_stoich_pp2_mrna, args=["DefaultCompartment"])
        },
    )
    m.add_reaction(
        "pp2_v2",
        ...
        stoichiometry={
            "pp2_mrna": Derived(fn=pp2_v2_stoich_pp2_mrna, args=["DefaultCompartment"])
        },
    )
    m.add_reaction(
        "pp2_v3",
        ...
        stoichiometry={"p2": Derived(fn=pp2_v3_stoich_p2, args=["DefaultCompartment"])},
    )
    m.add_reaction(
        "pp2_v4",
        fn=pp2_v4,
        args=["p2_conc", "p2_degradation_rate"],
        stoichiometry={"p2": Derived(fn=pp2_v4_stoich_p2, args=["DefaultCompartment"])},
    )
    m.add_reaction(
        "pp1_v1",
        fn=pp1_v1,
        args=["cod1"],
        stoichiometry={
            "pp1_mrna": Derived(fn=pp1_v1_stoich_pp1_mrna, args=["DefaultCompartment"])
        },
    )
    m.add_reaction(
        "pp1_v2",
        ...
        stoichiometry={
            "pp1_mrna": Derived(fn=pp1_v2_stoich_pp1_mrna, args=["DefaultCompartment"])
        },
    )
    m.add_reaction(
        "pp1_v3",
        ...
        stoichiometry={"p1": Derived(fn=pp1_v3_stoich_p1, args=["DefaultCompartment"])},
    )
    m.add_reaction(
        "pp1_v4",
        fn=pp1_v4,
        args=["p1_conc", "p1_degradation_rate"],
        stoichiometry={"p1": Derived(fn=pp1_v4_stoich_p1, args=["DefaultCompartment"])},
    )
