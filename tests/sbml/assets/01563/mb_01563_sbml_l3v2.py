...
def dS2_stoich() -> float:
    return 1


def dS3_stoich() -> float:
    return 1


def dS4_stoich() -> float:
    return math.pi


def dS5_stoich() -> float:
    return 1.0471975511966


def dS6_stoich() -> float:
    return (1 / 2) * math.pi


def dS7_stoich() -> float:
    return -0.523598775598299


def dS8_stoich() -> float:
    return 1.22777238637419


def dS9_stoich() -> float:
    return -1.43067687253053


def dS10_stoich() -> float:
    return 1


def dS11_stoich() -> float:
    return 4


def dS12_stoich() -> float:
    return -4


def dS13_stoich() -> float:
    return -0.947721602131112


def dS14_stoich() -> float:
    return 0.975897449330606


def dS15_stoich() -> float:
    return 1


def dS16_stoich() -> float:
    return math.e


def dS17_stoich() -> float:
    return 2.15976625378492


def dS18_stoich() -> float:
    return -5


def dS19_stoich() -> float:
    return 9


def dS20_stoich() -> float:
    return -1.6094379124341


def dS21_stoich() -> float:
    return 0


def dS22_stoich() -> float:
    return -1.6094379124341 / math.log(10)


def dS23_stoich() -> float:
    return 0


def dS24_stoich() -> float:
    return 1


def dS25_stoich() -> float:
    return 4


def dS26_stoich() -> float:
    return 5.5622817277544


def dS27_stoich() -> float:
    return 16


def dS28_stoich() -> float:
    return 9.61


def dS29_stoich() -> float:
    return 2


def dS30_stoich() -> float:
    return 2.72029410174709


def dS31_stoich() -> float:
    return 0.863209366648874


def dS32_stoich() -> float:
    return 0


def dS33_stoich() -> float:
    return 0.373876664830236


def dS34_stoich() -> float:
    return 0


def dS35_stoich() -> float:
    return 2.01433821447683


def dS36_stoich() -> float:
    return -math.tan(6)


def dS37_stoich() -> float:
    return 1.13949392732455


def dS38_stoich() -> float:
    return -1.0229863836713


def dS39_stoich() -> float:
    return 4.93315487558689


def dS40_stoich() -> float:
    return 0.304520293447143


def dS41_stoich() -> float:
    return 2.82831545788997


def dS42_stoich() -> float:
    return 1.12099946637054


def dS43_stoich() -> float:
    return 1.14109666064347


def dS44_stoich() -> float:
    return -1.47112767430373


def dS45_stoich() -> float:
    return math.asinh(99)


def dS46_stoich() -> float:
    return 0.802881971289134


def dS47_stoich() -> float:
    return -0.867300527694053


def dS48_stoich() -> float:
    return 1.51330668842682


def dS49_stoich() -> float:
    return 5.29834236561059


def dS50_stoich() -> float:
    return 1


def dS51_stoich() -> float:
    return 0
...
def create_model() -> KineticModelBuilder:
    ...
    m.add_variable("S0_stoich", initial_value=0.0)
    m.add_variable("S1_stoich", initial_value=0.0)
    m.add_variable("S2_stoich", initial_value=0.0)
    m.add_variable("S3_stoich", initial_value=0.0)
    m.add_variable("S4_stoich", initial_value=0.0)
    m.add_variable("S5_stoich", initial_value=0.0)
    m.add_variable("S6_stoich", initial_value=0.0)
    m.add_variable("S7_stoich", initial_value=0.0)
    m.add_variable("S8_stoich", initial_value=0.0)
    m.add_variable("S9_stoich", initial_value=0.0)
    m.add_variable("S10_stoich", initial_value=0.0)
    m.add_variable("S11_stoich", initial_value=0.0)
    m.add_variable("S12_stoich", initial_value=0.0)
    m.add_variable("S13_stoich", initial_value=0.0)
    m.add_variable("S14_stoich", initial_value=0.0)
    m.add_variable("S15_stoich", initial_value=0.0)
    m.add_variable("S16_stoich", initial_value=0.0)
    m.add_variable("S17_stoich", initial_value=0.0)
    m.add_variable("S18_stoich", initial_value=0.0)
    m.add_variable("S19_stoich", initial_value=0.0)
    m.add_variable("S20_stoich", initial_value=0.0)
    m.add_variable("S21_stoich", initial_value=0.0)
    m.add_variable("S22_stoich", initial_value=0.0)
    m.add_variable("S23_stoich", initial_value=0.0)
    m.add_variable("S24_stoich", initial_value=0.0)
    m.add_variable("S25_stoich", initial_value=0.0)
    m.add_variable("S26_stoich", initial_value=0.0)
    m.add_variable("S27_stoich", initial_value=0.0)
    m.add_variable("S28_stoich", initial_value=0.0)
    m.add_variable("S29_stoich", initial_value=0.0)
    m.add_variable("S30_stoich", initial_value=0.0)
    m.add_variable("S31_stoich", initial_value=0.0)
    m.add_variable("S32_stoich", initial_value=0.0)
    m.add_variable("S33_stoich", initial_value=0.0)
    m.add_variable("S34_stoich", initial_value=0.0)
    m.add_variable("S35_stoich", initial_value=0.0)
    m.add_variable("S36_stoich", initial_value=0.0)
    m.add_variable("S37_stoich", initial_value=0.0)
    m.add_variable("S38_stoich", initial_value=0.0)
    m.add_variable("S39_stoich", initial_value=0.0)
    m.add_variable("S40_stoich", initial_value=0.0)
    m.add_variable("S41_stoich", initial_value=0.0)
    m.add_variable("S42_stoich", initial_value=0.0)
    m.add_variable("S43_stoich", initial_value=0.0)
    m.add_variable("S44_stoich", initial_value=0.0)
    m.add_variable("S45_stoich", initial_value=0.0)
    m.add_variable("S46_stoich", initial_value=0.0)
    m.add_variable("S47_stoich", initial_value=0.0)
    m.add_variable("S48_stoich", initial_value=0.0)
    m.add_variable("S49_stoich", initial_value=0.0)
    m.add_variable("S50_stoich", initial_value=0.0)
    m.add_variable("S51_stoich", initial_value=0.0)
    m.add_variable("S0", initial_value=0.0)
    m.add_variable("S1", initial_value=0.0)
    m.add_variable("S2", initial_value=0.0)
    m.add_variable("S3", initial_value=0.0)
    m.add_variable("S4", initial_value=0.0)
    m.add_variable("S5", initial_value=0.0)
    m.add_variable("S6", initial_value=0.0)
    m.add_variable("S7", initial_value=0.0)
    m.add_variable("S8", initial_value=0.0)
    m.add_variable("S9", initial_value=0.0)
    m.add_variable("S10", initial_value=0.0)
    m.add_variable("S11", initial_value=0.0)
    m.add_variable("S12", initial_value=0.0)
    m.add_variable("S13", initial_value=0.0)
    m.add_variable("S14", initial_value=0.0)
    m.add_variable("S15", initial_value=0.0)
    m.add_variable("S16", initial_value=0.0)
    m.add_variable("S17", initial_value=0.0)
    m.add_variable("S18", initial_value=0.0)
    m.add_variable("S19", initial_value=0.0)
    m.add_variable("S20", initial_value=0.0)
    m.add_variable("S21", initial_value=0.0)
    m.add_variable("S22", initial_value=0.0)
    m.add_variable("S23", initial_value=0.0)
    m.add_variable("S24", initial_value=0.0)
    m.add_variable("S25", initial_value=0.0)
    m.add_variable("S26", initial_value=0.0)
    m.add_variable("S27", initial_value=0.0)
    m.add_variable("S28", initial_value=0.0)
    m.add_variable("S29", initial_value=0.0)
    m.add_variable("S30", initial_value=0.0)
    m.add_variable("S31", initial_value=0.0)
    m.add_variable("S32", initial_value=0.0)
    m.add_variable("S33", initial_value=0.0)
    m.add_variable("S34", initial_value=0.0)
    m.add_variable("S35", initial_value=0.0)
    m.add_variable("S36", initial_value=0.0)
    m.add_variable("S37", initial_value=0.0)
    m.add_variable("S38", initial_value=0.0)
    m.add_variable("S39", initial_value=0.0)
    m.add_variable("S40", initial_value=0.0)
    m.add_variable("S41", initial_value=0.0)
    m.add_variable("S42", initial_value=0.0)
    m.add_variable("S43", initial_value=0.0)
    m.add_variable("S44", initial_value=0.0)
    m.add_variable("S45", initial_value=0.0)
    m.add_variable("S46", initial_value=0.0)
    m.add_variable("S47", initial_value=0.0)
    m.add_variable("S48", initial_value=0.0)
    m.add_variable("S49", initial_value=0.0)
    m.add_variable("S50", initial_value=0.0)
    m.add_variable("S51", initial_value=0.0)
    m.add_parameter("C", value=1.0)
    m.add_reaction(
        "dS0_stoich",
        fn=dS0_stoich,
        args=[],
        stoichiometry={"S0_stoich": 1.0},
    )
    m.add_reaction(
        "dS1_stoich",
        fn=dS1_stoich,
    ...
    m.add_reaction(
        ...
        fn=dS2_stoich,
        args=[],
        stoichiometry={"S2_stoich": 1.0},
    )
    m.add_reaction(
        "dS3_stoich",
        fn=dS3_stoich,
        args=[],
        stoichiometry={"S3_stoich": 1.0},
    )
    m.add_reaction(
        "dS4_stoich",
        fn=dS4_stoich,
        args=[],
        stoichiometry={"S4_stoich": 1.0},
    )
    m.add_reaction(
        "dS5_stoich",
        fn=dS5_stoich,
        args=[],
        stoichiometry={"S5_stoich": 1.0},
    )
    m.add_reaction(
        "dS6_stoich",
        fn=dS6_stoich,
        args=[],
        stoichiometry={"S6_stoich": 1.0},
    )
    m.add_reaction(
        "dS7_stoich",
        fn=dS7_stoich,
        args=[],
        stoichiometry={"S7_stoich": 1.0},
    )
    m.add_reaction(
        "dS8_stoich",
        fn=dS8_stoich,
        args=[],
        stoichiometry={"S8_stoich": 1.0},
    )
    m.add_reaction(
        "dS9_stoich",
        fn=dS9_stoich,
        args=[],
        stoichiometry={"S9_stoich": 1.0},
    )
    m.add_reaction(
        "dS10_stoich",
        fn=dS10_stoich,
        args=[],
        stoichiometry={"S10_stoich": 1.0},
    )
    m.add_reaction(
        "dS11_stoich",
        fn=dS11_stoich,
        args=[],
        stoichiometry={"S11_stoich": 1.0},
    )
    m.add_reaction(
        "dS12_stoich",
        fn=dS12_stoich,
        args=[],
        stoichiometry={"S12_stoich": 1.0},
    )
    m.add_reaction(
        "dS13_stoich",
        fn=dS13_stoich,
        args=[],
        stoichiometry={"S13_stoich": 1.0},
    )
    m.add_reaction(
        "dS14_stoich",
        fn=dS14_stoich,
        args=[],
        stoichiometry={"S14_stoich": 1.0},
    )
    m.add_reaction(
        "dS15_stoich",
        fn=dS15_stoich,
        args=[],
        stoichiometry={"S15_stoich": 1.0},
    )
    m.add_reaction(
        "dS16_stoich",
        fn=dS16_stoich,
        args=[],
        stoichiometry={"S16_stoich": 1.0},
    )
    m.add_reaction(
        "dS17_stoich",
        fn=dS17_stoich,
        args=[],
        stoichiometry={"S17_stoich": 1.0},
    )
    m.add_reaction(
        "dS18_stoich",
        fn=dS18_stoich,
        args=[],
        stoichiometry={"S18_stoich": 1.0},
    )
    m.add_reaction(
        "dS19_stoich",
        fn=dS19_stoich,
        args=[],
        stoichiometry={"S19_stoich": 1.0},
    )
    m.add_reaction(
        "dS20_stoich",
        fn=dS20_stoich,
        args=[],
        stoichiometry={"S20_stoich": 1.0},
    )
    m.add_reaction(
        "dS21_stoich",
        fn=dS21_stoich,
        args=[],
        stoichiometry={"S21_stoich": 1.0},
    )
    m.add_reaction(
        "dS22_stoich",
        fn=dS22_stoich,
        args=[],
        stoichiometry={"S22_stoich": 1.0},
    )
    m.add_reaction(
        "dS23_stoich",
        fn=dS23_stoich,
        args=[],
        stoichiometry={"S23_stoich": 1.0},
    )
    m.add_reaction(
        "dS24_stoich",
        fn=dS24_stoich,
        args=[],
        stoichiometry={"S24_stoich": 1.0},
    )
    m.add_reaction(
        "dS25_stoich",
        fn=dS25_stoich,
        args=[],
        stoichiometry={"S25_stoich": 1.0},
    )
    m.add_reaction(
        "dS26_stoich",
        fn=dS26_stoich,
        args=[],
        stoichiometry={"S26_stoich": 1.0},
    )
    m.add_reaction(
        "dS27_stoich",
        fn=dS27_stoich,
        args=[],
        stoichiometry={"S27_stoich": 1.0},
    )
    m.add_reaction(
        "dS28_stoich",
        fn=dS28_stoich,
        args=[],
        stoichiometry={"S28_stoich": 1.0},
    )
    m.add_reaction(
        "dS29_stoich",
        fn=dS29_stoich,
        args=[],
        stoichiometry={"S29_stoich": 1.0},
    )
    m.add_reaction(
        "dS30_stoich",
        fn=dS30_stoich,
        args=[],
        stoichiometry={"S30_stoich": 1.0},
    )
    m.add_reaction(
        "dS31_stoich",
        fn=dS31_stoich,
        args=[],
        stoichiometry={"S31_stoich": 1.0},
    )
    m.add_reaction(
        "dS32_stoich",
        fn=dS32_stoich,
        args=[],
        stoichiometry={"S32_stoich": 1.0},
    )
    m.add_reaction(
        "dS33_stoich",
        fn=dS33_stoich,
        args=[],
        stoichiometry={"S33_stoich": 1.0},
    )
    m.add_reaction(
        "dS34_stoich",
        fn=dS34_stoich,
        args=[],
        stoichiometry={"S34_stoich": 1.0},
    )
    m.add_reaction(
        "dS35_stoich",
        fn=dS35_stoich,
        args=[],
        stoichiometry={"S35_stoich": 1.0},
    )
    m.add_reaction(
        "dS36_stoich",
        fn=dS36_stoich,
        args=[],
        stoichiometry={"S36_stoich": 1.0},
    )
    m.add_reaction(
        "dS37_stoich",
        fn=dS37_stoich,
        args=[],
        stoichiometry={"S37_stoich": 1.0},
    )
    m.add_reaction(
        "dS38_stoich",
        fn=dS38_stoich,
        args=[],
        stoichiometry={"S38_stoich": 1.0},
    )
    m.add_reaction(
        "dS39_stoich",
        fn=dS39_stoich,
        args=[],
        stoichiometry={"S39_stoich": 1.0},
    )
    m.add_reaction(
        "dS40_stoich",
        fn=dS40_stoich,
        args=[],
        stoichiometry={"S40_stoich": 1.0},
    )
    m.add_reaction(
        "dS41_stoich",
        fn=dS41_stoich,
        args=[],
        stoichiometry={"S41_stoich": 1.0},
    )
    m.add_reaction(
        "dS42_stoich",
        fn=dS42_stoich,
        args=[],
        stoichiometry={"S42_stoich": 1.0},
    )
    m.add_reaction(
        "dS43_stoich",
        fn=dS43_stoich,
        args=[],
        stoichiometry={"S43_stoich": 1.0},
    )
    m.add_reaction(
        "dS44_stoich",
        fn=dS44_stoich,
        args=[],
        stoichiometry={"S44_stoich": 1.0},
    )
    m.add_reaction(
        "dS45_stoich",
        fn=dS45_stoich,
        args=[],
        stoichiometry={"S45_stoich": 1.0},
    )
    m.add_reaction(
        "dS46_stoich",
        fn=dS46_stoich,
        args=[],
        stoichiometry={"S46_stoich": 1.0},
    )
    m.add_reaction(
        "dS47_stoich",
        fn=dS47_stoich,
        args=[],
        stoichiometry={"S47_stoich": 1.0},
    )
    m.add_reaction(
        "dS48_stoich",
        fn=dS48_stoich,
        args=[],
        stoichiometry={"S48_stoich": 1.0},
    )
    m.add_reaction(
        "dS49_stoich",
        fn=dS49_stoich,
        args=[],
        stoichiometry={"S49_stoich": 1.0},
    )
    m.add_reaction(
        "dS50_stoich",
        fn=dS50_stoich,
        args=[],
        stoichiometry={"S50_stoich": 1.0},
    )
    m.add_reaction(
        "dS51_stoich",
        fn=dS51_stoich,
        args=[],
        stoichiometry={"S51_stoich": 1.0},
    )
    m.add_reaction(
        "J0",
        fn=J0,
