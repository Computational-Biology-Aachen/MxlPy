...
def reaction1(k: float, S2_conc: float, S1_conc: float, S3_conc: float) -> float:
    return S1_conc * S2_conc * S3_conc * k
...
def create_model() -> Model:
    return (
        ...
        .add_variable("S3", initial_value=0.75)
        .add_variable("S4", initial_value=0.0)
        .add_parameter("k", value=0.8)
        ...
        .add_reaction(
            "reaction1",
            fn=reaction1,
            args=["k", "S2_conc", "S1_conc", "S3_conc"],
            stoichiometry={
