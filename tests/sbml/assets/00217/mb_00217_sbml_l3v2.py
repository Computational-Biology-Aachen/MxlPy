...
def create_model() -> Model:
    return (
        ...
        .add_parameter("S1", value=0.01)
        .add_parameter("S3", value=0.01)
        .add_derived(
            "S1_conc",
            fn=S1_conc,
            args=["compartment", "S1"],
        ...
        .add_reaction(
            ...
            stoichiometry={"S2": Derived(fn=reaction1_stoich_S2, args=["compartment"])},
        )
        .add_reaction(
            "reaction2",
            fn=reaction2,
            args=["compartment", "S3_conc", "k2"],
            stoichiometry={"S2": Derived(fn=reaction2_stoich_S2, args=["compartment"])},
        )
    )
