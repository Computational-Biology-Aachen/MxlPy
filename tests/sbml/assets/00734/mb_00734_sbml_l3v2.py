...
def reaction1(reaction1_k1: float, S1_conc: float) -> float:
    return S1_conc * reaction1_k1
...
def reaction2(reaction2_k2: float, S3_conc: float) -> float:
    return S3_conc * reaction2_k2
...
def create_model() -> Model:
    return (
        ...
        .add_parameter("reaction1_k1", value=0.01)
        .add_parameter("reaction2_k2", value=0.4)
        .add_derived(
            "S4",
            fn=S4,
            args=["S1", "k3"],
