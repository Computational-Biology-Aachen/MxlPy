...
def reaction2(S4_conc: float, S5_conc: float, S3_conc: float, k2: float) -> float:
    return S3_conc * S4_conc * k2 / S5_conc
...
def create_model() -> Model:
    return (
        ...
        .add_variable("S5", initial_value=1.0e-6)
        .add_parameter("k1", value=1300.0)
        .add_parameter("k2", value=0.3)
        .add_parameter("compartment", value=0.2)
        .add_derived(
            "S1_conc",
            fn=S1_conc,
            args=["compartment", "S1"],
        ...
        .add_reaction(
            "reaction2",
            fn=reaction2,
            args=["S4_conc", "S5_conc", "S3_conc", "k2"],
            stoichiometry={
