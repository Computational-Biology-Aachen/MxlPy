...
def reaction1(S1_conc: float, S3_conc: float, k1: float) -> float:
    return S1_conc * S3_conc * k1
...
def create_model() -> Model:
    return (
        ...
        .add_variable("S3", initial_value=1.2)
        .add_parameter("k1", value=1.78)
        .add_parameter("compartment", value=1.34)
        .add_derived(
            "S1_conc",
            fn=S1_conc,
            args=["compartment", "S1"],
