...
def dk1(k3: float, p1: float, k2: float) -> float:
    return p1 * (k2 + k3)
...
def create_model() -> Model:
    return (
        Model()
        .add_variable("k1", initial_value=1000000.0)
        ...
        .add_parameter("k2", value=300000.0)
        .add_parameter("k3", value=700000.0)
        .add_parameter("p1", value=1.0)
        .add_parameter("C", value=0.15)
        .add_derived(
            "S1_conc",
            fn=S1_conc,
            args=["C", "S1"],
