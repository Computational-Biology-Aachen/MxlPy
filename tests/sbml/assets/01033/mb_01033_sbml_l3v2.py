...
def reaction1(
    S2_conc: float, S1_conc: float, kr: float, kf: float, S3_conc: float
) -> float:
    return -S1_conc * S2_conc * kf + S3_conc * kr
...
def create_model() -> Model:
    return (
        ...
        .add_reaction(
            "reaction1",
            fn=reaction1,
            args=["S2_conc", "S1_conc", "kr", "kf", "S3_conc"],
            stoichiometry={
