...
def init_S4(C: float, p1: float) -> float:
    return 2 * C * p1
...
def reaction1(S4_conc: float, S1_conc: float, k1: float) -> float:
    return S1_conc * S4_conc * k1
