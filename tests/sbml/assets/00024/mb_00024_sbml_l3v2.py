...
def reaction3_stoich_S2(compartment: float) -> float:
    return -1.0 * compartment
...
def reaction4_stoich_S2(compartment: float) -> float:
    return 1.0 * compartment
...
def create_model() -> Model:
    return (
        ...
        .add_reaction(
            ...
            args=["S2_conc", "k3"],
            stoichiometry={
                "S2": Derived(fn=reaction3_stoich_S2, args=["compartment"]),
        ...
        .add_reaction(
            ...
            stoichiometry={
                ...
                "S2": Derived(fn=reaction4_stoich_S2, args=["compartment"]),
            },
        )
    )
