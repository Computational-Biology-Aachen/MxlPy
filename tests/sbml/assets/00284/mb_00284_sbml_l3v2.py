...
def create_model() -> Model:
    return (
        Model()
        .add_variable("S1", initial_value=0.009)
        .add_variable("S2", initial_value=0.011)
        .add_variable("S3", initial_value=0.012)
        .add_variable("S4", initial_value=0.01)
        .add_parameter("k1", value=127.5)
        .add_parameter("k2", value=2.5)
        .add_parameter("compartment", value=1.98)
        .add_derived(
            "S1_conc",
            fn=S1_conc,
            args=["compartment", "S1"],
